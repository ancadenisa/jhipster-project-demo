 ...
 * </jhipster-entity-replacer>
 */
@ApiModel(description = "<jhipster-entity-replacer>replacer.replaceRegexWithCurlyBraceBlock("\\s*?(?:@Override)?\\s*public boolean equals\\(\\w+ \\w+\\)");</jhipster-entity-replacer>")
@Entity
@Table(name = "entry")
