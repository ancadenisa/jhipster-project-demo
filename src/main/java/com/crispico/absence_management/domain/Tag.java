...
public class Tag implements Serializable {
    ...
    @NotNull
    @Size(min = 2)
    @ApiModelProperty(value = "<jhipster-entity-replacer>replacer.applyStoredReplacements("defaultAbstractEntity"); replacer.insertElement("@Named"); </jhipster-entity-replacer>", required = true)
